...
label_conf_0 = gs.Variable(name='label_conf_0',shape=(1,8400,3),dtype=np.float32) #《----------
...
label_conf = gs.Variable(name='label_conf',shape=(1,8400,3),dtype=np.float32)  #《-------------
...
#----处理prob
scores = gs.Variable(name="scores",shape=(1,8400,3),dtype=np.float32)  #《-----------
